...
if (length(args) < 9) {
  stop(
    "Usage: run_r_uwot_algo.R <input.csv> <output.csv> <n_neighbors> <n_components> <n_epochs> <seed> <init> <warmup> <repeats> [knn_idx.csv] [knn_dist.csv]"
  )
}
